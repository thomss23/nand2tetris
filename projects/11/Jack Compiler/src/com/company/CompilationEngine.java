...
public class CompilationEngine {
    ...
    public void compileClass() throws Exception {
        ...
        compileClassVarDec();
        while(!(jt.tokenType() == SYMBOL && jt.symbol().equals("}"))) {
            compileSubroutine();
        }
    ...
    private ArrayList<String[]> compileParameterList() {
        ...
        while(!(jt.tokenType() == SYMBOL && jt.symbol().equals(")"))) {
            ...
            if(jt.tokenType() == SYMBOL && jt.symbol().equals(",")) getSymbol();
            // get param type
            type = getType();
            // get param name
            name = getIdentifier();
    ...
    private void compileLet() {
        ...
        if(jt.tokenType() == SYMBOL && jt.symbol().equals("[")) {
        ...
        } else if(jt.tokenType() == SYMBOL && jt.symbol().equals("=")) {
            // consume =
            getSymbol();
            compileExpression();
            // consume ;
    ...
    private void compileTerm() {
        if(jt.tokenType() == INT_CONST) {
            ...
            if(jt.tokenType() == SYMBOL && jt.symbol().equals("[")) {
                ...
                vm.writePop("pointer", 1);
                vm.writePush("that", 0);
            } else if(jt.tokenType() == SYMBOL && jt.symbol().equals("(")) {   // must be method call on this
    ...
    private boolean isOperator() {
        if(jt.tokenType() == SYMBOL) {
            return (jt.symbol().equals("+") || jt.symbol().equals("-") || jt.symbol().equals("*")
                    || jt.symbol().equals("/") || jt.symbol().equals("&") || jt.symbol().equals("|") || jt.symbol().equals("<")
                    || jt.symbol().equals(">") || jt.symbol().equals("="));
        } else {
            return false;
        }
    ...
    private boolean isUnaryOp() {
        return (jt.tokenType() == SYMBOL && (jt.symbol().equals("-") || jt.symbol().equals("~")));
    }
    ...
    private boolean isStartOfTerm() {
        ...
        if(jt.tokenType() == SYMBOL && jt.symbol().equals("(")) return true;
        return isUnaryOp();
    }
